...
pbxProject.prototype.pbxBuildPhase = function () {
    return this.hash.project.objects['PBXShellScriptBuildPhase'];
}

pbxProject.prototype.pbxVariantGroup = function () {
    
    if(!this.hash.project.objects['PBXVariantGroup']) {
